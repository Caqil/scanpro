...
export default {
  ...
  removeWatermark: {
    ...
    description: "Effortlessly remove text and image watermarks from your PDF documents while preserving quality",
    uploadTitle: "Upload PDF to Remove Watermark",
    uploadDesc: "Drag and drop your PDF file here, or click to browse",
    removeWatermark: "Remove Watermark",
    processing: "Removing Watermark...",
    processingDesc: "Please wait while we process your document",
    success: "Watermark Removal Complete!",
    successDesc: "Your PDF has been processed and watermarks have been removed or minimized",
    form: {
      removalMethod: "Removal Method",
      standardMethod: "Standard (Basic removal)",
      advancedMethod: "Advanced (Better for complex watermarks)",
      watermarkType: "Watermark Type",
      bothTypes: "Both text and image watermarks",
      textWatermarks: "Text watermarks only",
      imageWatermarks: "Image watermarks only",
      textPattern: "Text Pattern (Optional)",
      textPatternPlaceholder: "e.g., CONFIDENTIAL, DRAFT, etc.",
      textPatternHint: "Enter specific text in the watermark for more accurate removal",
      advancedOptions: "Advanced Options",
      enhanceContrast: "Enhance text contrast",
      enhanceContrastHint: "Improve readability of text after watermark removal",
      backgroundCleanup: "Clean up background",
      backgroundCleanupHint: "Remove background noise and artifacts",
      preserveFormFields: "Preserve form fields",
      preserveFormFieldsHint: "Maintain interactive form elements if present"
    },
    errors: {
      noFile: "No PDF file selected",
      invalidFile: "Invalid file type. Please select a PDF file.",
      failed: "Failed to remove watermark",
      unknown: "An unknown error occurred"
    },
    howTo: {
      ...
      step1: {
        title: "Upload Your PDF",
        description: "Select and upload the PDF document containing watermarks you want to remove"
      },
      step2: {
        title: "Choose Removal Options",
        description: "Select the watermark type and customize settings for optimal removal"
      },
      step3: {
        title: "Download Clean PDF",
        description: "Process and download your PDF with watermarks removed or minimized"
      }
    },
    benefits: {
      title: "Benefits of Watermark Removal",
      cleanDocuments: {
        title: "Clean Documents",
        description: "Get distraction-free documents for better readability and professional appearance"
      },
      improvedPrivacy: {
        title: "Improved Privacy",
        description: "Remove distracting or private information before sharing documents"
      },
      archiveQuality: {
        title: "Archive Quality",
        description: "Create clean copies of documents for archiving or repurposing"
      },
      fileOptimization: {
        title: "File Optimization",
        description: "Removing watermarks can reduce file size and improve document quality"
      }
    },
    faq: {
      title: "Frequently Asked Questions",
      types: {
        question: "Can all types of watermarks be removed?",
        answer: "Our tool works best with standard text and image watermarks. Success varies based on how the watermark was applied. Simple transparent watermarks are easier to remove than complex, integrated ones."
      },
      damage: {
        question: "Will this damage my PDF document?",
        answer: "Our tool is designed to preserve document content. However, the process may slightly affect formatting in some cases. We recommend keeping a backup of your original file and using the 'Preserve Form Fields' option if your document contains forms."
      },
      method: {
        question: "Which method should I choose?",
        answer: "Start with the 'Standard' method for most watermarks. If results aren't satisfactory, try the 'Advanced' method which uses more intensive processing techniques but may take longer. For text watermarks, providing the exact text pattern can improve results."
      },
      security: {
        question: "Is my PDF secure during processing?",
        answer: "Yes, all files are processed securely on our servers and automatically deleted after 24 hours. We don't store or access the content of your documents beyond what's needed for processing."
      }
    },
