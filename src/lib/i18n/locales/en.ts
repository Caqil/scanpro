...
export default {
  ...
  dashboard: {
    apiKeys: {
      title: "API Keys",
      description: "Create and manage API keys to access ScanPro from your applications",
      createButton: "Create API Key",
      createTitle: "Create New API Key",
      createDescription: "API keys allow external applications to authenticate with ScanPro API.",
      name: "Name",
      namePlaceholder: "My App",
      nameRequired: "Please enter a name for your API key",
      fetchError: "Failed to load API keys",
      createError: "Failed to create API key",
      keyCreated: "API Key Created",
      keyCreatedDescription: "Copy this API key now. You won't be able to see it again!",
      importantNote: "Important",
      keyWarning: "This key will only be displayed once. Store it securely - you'll need to create a new key if you lose it.",
      ...
      deleteDescription: "This action cannot be undone. This will permanently delete the API key.",
      deleteConfirm: "Are you sure you want to delete the API key \"{{name}}\"?",
      deleteWarning: "Any applications using this key will no longer be able to access the API.",
      ...
      noKeysDescription: "You haven't created any API keys yet. API keys allow your applications to authenticate with the ScanPro API.",
      documentationTitle: "API Documentation",
      documentationDescription: "Learn how to use the ScanPro API in your applications",
      documentationSubtext: "Our comprehensive API documentation provides all the information you need to integrate ScanPro's powerful PDF and image processing capabilities into your applications.",
