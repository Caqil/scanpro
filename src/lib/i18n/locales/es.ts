...
export default {
    ...
    ocr: {
      ...
      whatIsOcr: {
        title: "¿Qué es OCR?",
        description: "El Reconocimiento Óptico de Caracteres (OCR) es una tecnología que convierte diferentes tipos de documentos, como documentos en papel escaneados, archivos PDF o imágenes capturadas por una cámara digital, en datos editables y buscables."
      },
      whenToUse: {
      ...
      limitations: {
        ...
        description: "Aunque nuestra tecnología OCR es potente, hay algunas limitaciones que debes conocer:",
