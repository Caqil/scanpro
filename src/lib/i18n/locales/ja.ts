...
export default {
  ...
  compressPdf: {
    ...
    howTo: {
      ...
      step1: {
        title: "PDFをアップロード",
        description: "圧縮したいPDFファイルをアップロードします。100MBまでのファイルがサポートされています。"
      },
      step2: {
        title: "品質を選択",
        description: "必要に応じて希望の圧縮レベルを選択します。"
      },
      step3: {
        title: "ダウンロード",
        description: "圧縮されたPDFファイルをダウンロードし、共有または保存できます。"
      }
    },
    why: {
      title: "PDFを圧縮する理由",
      uploadSpeed: {
        title: "超高速アップロード",
        description: "圧縮されたPDFをより高速なアップロード速度で素早く共有"
      },
      emailFriendly: {
        title: "メール対応",
        description: "品質を損なうことなくメールのサイズ制限に適合"
      },
      storage: {
        title: "効率的なストレージ",
        description: "デバイスやクラウドストレージのスペースを最大限に活用"
      },
      quality: {
        title: "品質維持",
        description: "必要な品質を維持する圧縮レベルを選択"
      }
    },
    faq: {
      title: "よくある質問",
      howMuch: {
        ...
        answer: "ほとんどのPDFファイルは、内容に応じて20〜80％圧縮できます。画像が多いドキュメントは、テキストが多いドキュメントよりも高い圧縮率を達成します。当社の圧縮ツールは、ファイルサイズと視覚品質をニーズに合わせてバランスさせるさまざまな品質レベルを提供します。"
      },
      quality: {
        question: "圧縮はPDFの品質に影響しますか？",
        answer: "当社の圧縮ツールはさまざまな品質設定を提供します。高品質圧縮は視覚的な忠実度を維持しながらファイルサイズを削減します。中品質および低品質設定はより積極的な圧縮を適用し、画像品質に影響を与える可能性がありますが、より小さなファイルサイズになります。テキストコンテンツはすべての圧縮レベルで鮮明で読みやすくなります。"
      },
      secure: {
        question: "圧縮中にPDFデータは安全ですか？",
        answer: "はい、当社はデータセキュリティを非常に重視しています。すべてのファイル処理は安全なサーバーで行われ、ファイルは処理後（通常24時間以内）に自動的に削除されます。ファイルを第三者と共有することはなく、すべてのデータ転送はHTTPSを使用して暗号化されます。"
      },
      fileLimits: {
        question: "ファイルサイズの制限は何ですか？",
        answer: "無料ユーザーは10MBまでのPDFファイルを圧縮できます。プレミアム会員はより大きなファイルを圧縮できます：基本プランは50MBまで、プロプランは100MBまで、エンタープライズプランはファイルあたり500MBまでです。より大きなファイルを処理する必要がある場合は、カスタムソリューションについてお問い合わせください。"
      },
      batch: {
        question: "複数のPDFを一度に圧縮できますか？",
        answer: "はい、当社のツールはバッチ圧縮をサポートしています。複数のPDFファイルを同時にアップロードして圧縮できるため、複数のドキュメントを処理する時間を節約できます。プレミアムユーザーはバッチ処理でより高い制限を得られます。"
      }
    },
    modes: {
      title: "圧縮モード",
      moderate: {
        title: "中程度の圧縮",
        description: "ファイルサイズを削減しながら良好な視覚品質を維持するバランスの取れたアプローチ。品質が重要だが一定のサイズ削減が必要なほとんどのドキュメントに最適です。"
      },
      high: {
        title: "高圧縮",
        description: "ファイルサイズを大幅に削減するより積極的な圧縮。画像品質に若干の低下が見られる場合がありますが、テキストは明確で読みやすくなります。"
      },
      lossless: {
        title: "ロスレス圧縮",
        description: "冗長データを削除し、構造を最適化し、メタデータをクリーンアップすることで、品質に影響を与えずにファイルサイズを削減します。オリジナルとの視覚的な違いはありません。"
      }
    },
    bestPractices: {
      ...
      donts: "非推奨事項",
      dosList: [
        "PDFを作成する前に画像を圧縮してより良い結果を得る",
        "ニーズに合った適切な圧縮レベルを選択する",
        "圧縮前に元のファイルをバックアップとして保存する",
        "重要なドキュメントにはロスレス圧縮を使用する",
        "ファイルサイズをさらに減らすために不要なページを削除する"
      ],
      dontsList: [
        "印刷に必要なドキュメントを過度に圧縮しない",
        "すべての詳細が重要な法的またはアーカイブドキュメントを圧縮しない",
        "既に高度に圧縮されたPDFを繰り返し圧縮しない",
        "主にテキストを含むPDFで大幅な削減を期待しない",
  ...
  unlockPdf: {
    title: "PDFファイルのロック解除",
    description: "制限なしでアクセスできるようにPDFドキュメントからパスワード保護を解除",
    howTo: {
      title: "PDFファイルをロック解除する方法",
      upload: {
        title: "アップロード",
        description: "ロック解除したいパスワード保護されたPDFファイルをアップロード。"
      },
      enterPassword: {
        title: "パスワード入力",
        description: "必要に応じて、PDFを保護している現在のパスワードを入力。"
      },
      download: {
        title: "ダウンロード",
        description: "パスワード制限のないロック解除されたPDFファイルをダウンロード。"
      }
    },
    faq: {
      passwordRequired: {
        question: "現在のパスワードを知る必要がありますか？",
        answer: "はい、PDFをロック解除するには現在のパスワードを知る必要があります。当社のツールはパスワードを回避またはクラックできません。正しいパスワードを提供後に保護を解除します。"
      },
      security: {
        question: "ロック解除プロセスは安全ですか？",
        answer: "はい、すべての処理は安全なサーバー上で行われます。PDFやパスワードは保存しません。処理後にファイルは自動的に削除され、すべてのデータ転送は暗号化されます。"
      },
      restrictions: {
        question: "開くパスワードがないが所有者制限のあるPDFをロック解除できますか？",
        answer: "はい、開くためのパスワードが必要ないが印刷、編集、コピーに制限があるPDFもあります。当社のツールはこれらの制限も解除可能。パスワードを入力せずにファイルをアップロードしてください。"
      },
      quality: {
        question: "ロック解除はPDFの品質やコンテンツに影響しますか？",
        answer: "いいえ、ロック解除プロセスはセキュリティ設定を解除するだけで、PDFファイルのコンテンツ、書式、品質には一切影響しません。"
      }
    },
    passwordProtected: "パスワード保護されています",
    notPasswordProtected: "パスワード保護されていません",
    unlocking: "PDFをロック解除中...",
    unlockSuccess: "PDFが正常にロック解除されました！",
    unlockSuccessDesc: "PDFファイルがロック解除され、ダウンロードの準備が整いました。"
  },
  ...
  security: {
    hero: {
      ...
      subtitle: "私たちはあなたのドキュメントのセキュリティとプライバシーを真剣に考えています。データ保護の方法をご覧ください。"
    },
    measures: {
      title: "データ保護の方法"
    },
