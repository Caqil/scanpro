...
export default {
  metadata: {
    title: "ScanPro - オールインワンPDF変換＆編集 | 無料オンライン",
    template: "%s | ScanPro PDFツール",
    description: "強力な無料オンラインツール：変換、圧縮、結合、分割、編集、OCRなど。インストール不要。",
  },
  nav: {
    tools: "ツール",
    company: "会社",
  ...
  compressPdf: {
    title: "PDF圧縮",
    description: "品質を維持しつつPDFファイルサイズを削減",
    quality: {
      high: "高品質",
      highDesc: "最小限の圧縮、最高の視覚品質",
      balanced: "バランス",
      balancedDesc: "良好な圧縮と最小限の視覚的損失",
      maximum: "最大圧縮",
      maximumDesc: "最高の圧縮率、視覚品質が低下する場合あり"
    },
    processing: {
      title: "処理オプション",
    ...
    error: {
      ...
      downloadZip: "ZIPアーカイブのダウンロードに失敗",
      generic: "PDFファイルの圧縮に失敗",
      unknown: "不明なエラーが発生",
      failed: "ファイルの圧縮に失敗"
    }
  },
