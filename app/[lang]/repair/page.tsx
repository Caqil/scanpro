...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const title = t("repairPdf.title") || "Repair PDF Files";
  const description = t("repairPdf.description") || "Fix corrupted PDF files, recover content, and optimize document structure";
