...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const title = t("developer.title") || "Developer API Documentation";
  const description = t("developer.description") || "Integrate ScanPro's powerful PDF tools into your applications with our RESTful API";
    ...
    alternates: {
      ...
      languages: Object.fromEntries(
        SUPPORTED_LANGUAGES.map(code => {
          ...
          return [langCode, `/${code}/developer`];
        })
      ),
    }
  };
