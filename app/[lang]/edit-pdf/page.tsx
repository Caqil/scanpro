...
import { EditHeaderSection, HowToEditSection, EditFAQSection, RelatedToolsSection } from "./edit-content";
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const title = t("editPdf.title") || "Edit PDF Online | Free PDF Editor";
  const description = t("editPdf.description") || "Edit and modify PDF documents online. Add text, images, shapes and drawings to your PDF files with this free online PDF editor.";
