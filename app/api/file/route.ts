...
export async function GET(req: Request) {
  ...
  if (!folder || !filename || !["conversions", "compressions", "merges", "splits", "rotations", "watermarks", , "protected", "unlocked", "signatures", "ocr", "edited", "processed", "processed-images"].includes(folder)) {
