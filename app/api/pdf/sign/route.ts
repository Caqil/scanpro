        ...
        for (let pageIndex = 0; pageIndex < pdfDoc.getPageCount(); pageIndex++) {
          ...
          for (const element of pageElements) {
            ...
            if (element.type === "signature" || element.type === "image") {
              ...
              try {
                const font = await pdfDoc.embedFont(element.fontFamily || "Helvetica");
                ...
                page.drawText(element.data, {
                  x: pdfX,
                  y: pdfY + (element.size.height * scaleY) / 2, // Adjust for text baseline
                ...
                console.log(`Added text to page ${pageIndex + 1} at (${pdfX}, ${pdfY})`);
              } catch (error) {
              ...
              try {
                ...
                page.drawText(element.data.toUpperCase(), {
                  x: pdfX + (element.size.width * scaleX) / 2 - 40,
                  y: pdfY + (element.size.height * scaleY) / 2,
                  size: 20 * scaleX,
                  font,
                  color: rgb(1, 0, 0),
                  rotate: element.rotation ? degrees(element.rotation) : undefined,
                ...
                console.log(`Added stamp to page ${pageIndex + 1} at (${pdfX}, ${pdfY})`);
              } catch (error) {
