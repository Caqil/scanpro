                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {formatFileSize(file.size)} • {t('compressPdf.files')} {totalPages} {t('compressPdf.of')}
                    </p>
                  </div>
                  <Button 
                    type="button" 
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('convert.options.pageOptions')}</FormLabel>
                        <Select
                          disabled={isProcessing}
                          onValueChange={field.onChange}
                          defaultValue={field.value}
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue placeholder={t('convert.options.pageOptions')} />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                            <SelectItem value="all">{t('convert.options.allPages')}</SelectItem>
                            <SelectItem value="specific">{t('convert.options.selectedPages')}</SelectItem>
                          </SelectContent>
                        </Select>
                        <FormMessage />
                      </FormItem>
                ...
                <div className="space-y-4">
                  <h3 className="text-sm font-medium">{t('convert.options.title')}</h3>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>{t('ocr.options.enhanceScanned')}</FormLabel>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>{t('ocr.options.preserveLayout')}</FormLabel>
                          <p className="text-sm text-muted-foreground">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col items-center justify-center gap-2 text-sm text-muted-foreground">
                  ...
                  <div className="text-center">
                    <p className="font-medium">{t('ocr.processing.title')}... {progress}%</p>
            ...
            {extractedText && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-medium">{t('ocr.results.title')}</h3>
                    ...
                    {textFile && (
                      ...
                      >
                        <a
                          ...
                          download
                        >
                          <DownloadIcon className="h-4 w-4 mr-1" /> {t('ocr.results.download')}
                        </a>
                      </Button>
                    )}
                  </div>
