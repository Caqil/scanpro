    ...
    try {
      ...
      if (data.success) {
        ...
        toast.error("Repair process completed with issues", {
          description: data.message || "The repair process encountered some issues"
        });
      }
    } catch (error) {
      ...
      setRepairResult({
        success: false,
        message: error instanceof Error ? error.message : "Failed to repair PDF"
      });
    } finally {
      ...
      <div className="space-y-2">
        ...
        >
          <div className="flex items-start space-x-2">
            ...
            <div>
              <Label htmlFor="standard" className="flex items-center gap-1 font-medium">
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              <Label htmlFor="advanced" className="flex items-center gap-1 font-medium">
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              <Label htmlFor="optimization" className="flex items-center gap-1 font-medium">
        ...
        {hasAdvancedOptions && (
          <div className="space-y-3 bg-muted/20 p-3 rounded-md mt-2">
            <div className="flex items-start space-x-2">
              ...
              />
              <div>
                <Label htmlFor="preserveFormFields" className="text-sm font-medium">
            ...
            <div className="flex items-start space-x-2">
              ...
              />
              <div>
                <Label htmlFor="preserveAnnotations" className="text-sm font-medium">
            ...
            <div className="flex items-start space-x-2">
              ...
              />
              <div>
                <Label htmlFor="preserveBookmarks" className="text-sm font-medium">
                  Preserve Bookmarks
                </Label>
                <p className="text-xs text-muted-foreground">
  ...
  const renderProcessingState = () => (
    <div className="space-y-4 py-4">
      ...
      <p className="text-xs text-center text-muted-foreground">
        Please wait while we repair your document. This may take a few minutes depending on the file size and complexity.
      </p>
    </div>
  );
      ...
      <div className="space-y-4">
        {repairResult.success ? (
          <Alert className="bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800">
            ...
            <AlertDescription>
              {repairResult.message || "Your PDF has been repaired and is ready for download."}
            </AlertDescription>
          </Alert>
        ) : (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              {repairResult.message || "We encountered issues while repairing your PDF. Some content may not be recoverable."}
            </AlertDescription>
          </Alert>
        )}
        ...
        {repairResult.details && (
          <Card className="mt-4">
            ...
            <CardContent className="space-y-3 text-sm">
              {repairResult.details.fixed && repairResult.details.fixed.length > 0 && (
                <div>
              ...
              {repairResult.details.warnings && repairResult.details.warnings.length > 0 && (
                <div>
              ...
              {repairResult.details.originalSize !== undefined && repairResult.details.newSize !== undefined && (
                <div>
                  <h4 className="font-medium flex items-center gap-1">
                    <File className="h-4 w-4" /> File Size
                  </h4>
                  <p className="text-muted-foreground mt-1">
                    Original: {formatFileSize(repairResult.details.originalSize)} → 
                    New: {formatFileSize(repairResult.details.newSize)}
                    {repairResult.details.originalSize > repairResult.details.newSize && (
                      <span className="text-green-600 dark:text-green-400 ml-2">
                        ({Math.round((1 - repairResult.details.newSize / repairResult.details.originalSize) * 100)}% reduction)
                      </span>
                    )}
                  </p>
                </div>
        ...
        <CardFooter className="border-t px-6 py-4">
          <div className="flex items-start gap-2 text-xs text-muted-foreground">
            ...
            <p>
              ...
              We support various repair methods including cross-reference reconstruction, content stream repair, and structure optimization.
            </p>
          </div>
        </CardFooter>
      )}
